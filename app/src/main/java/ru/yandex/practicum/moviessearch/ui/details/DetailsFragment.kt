...
class DetailsFragment : Fragment() {
    ...
    companion object {
        ...
        fun createArgs(movieId: String, posterId: String): Bundle =
            bundleOf(ARGS_MOVIE_ID to movieId, ARGS_POSTER_URL to posterId)

        // Тэг для использования в FragmentManager
